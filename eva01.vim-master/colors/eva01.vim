...
" General colors"{{{
hi Normal ctermfg=130 ctermbg=NONE cterm=NONE guifg=#D0D0D0 guibg=#1C1C1C gui=NONE
...
hi CursorLineNr ctermfg=102 ctermbg=233 cterm=bold guifg=#000000 guibg=#121212 gui=bold
...
"}}}
" Syntax highlighting"{{{
hi Comment ctermfg=88 ctermbg=NONE cterm=NONE guifg=#00875F guibg=NONE gui=italic
hi Constant ctermfg=156 ctermbg=NONE cterm=NONE guifg=#AFFF87 guibg=NONE gui=NONE
hi String ctermfg=14 ctermbg=NONE cterm=NONE guifg=#AFD7AF guibg=NONE gui=NONE
hi Number ctermfg=160 ctermbg=NONE cterm=NONE guifg=#D7AF5F guibg=NONE gui=NONE
hi PreProc ctermfg=15 ctermbg=NONE cterm=NONE guifg=#AF5FFF guibg=NONE gui=NONE
hi Identifier ctermfg=147 ctermbg=NONE cterm=NONE guifg=#AFAFFF guibg=NONE gui=NONE
hi Statement ctermfg=88 ctermbg=NONE cterm=NONE guifg=#D75FFF guibg=NONE gui=NONE
hi Type ctermfg=127 ctermbg=NONE cterm=NONE guifg=#AFFF87 guibg=NONE gui=NONE
